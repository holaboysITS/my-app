		...
		<div className="form-box">
			<form className="form">
				...
				<div className="form-container">
					<input type="Nomei" className="input" placeholder="Nome string" />
					<input type="Location" className="input" placeholder="Location String" />
					<input type="Description" className="input" placeholder="Description" />
					<input type="machinary" className="input" placeholder="Machinary List" />
				</div>
