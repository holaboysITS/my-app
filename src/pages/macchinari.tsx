...
import { getMachineryItems, getPlantItems } from '../utility/helpers/services';
		...
		<div className="form-box">
			<form className="form">
				...
				<div className="form-container">
					<input type="Nome" className="input" placeholder="Nome string" />
					<input type="Specifications" className="input" placeholder="Specifications dict" />
					<input type="Type" className="input" placeholder="Type string" />
					<input type="Status" className="input" placeholder="Status Enum" />
					<input type="Id" className="input" placeholder="Id int" />
				</div>
